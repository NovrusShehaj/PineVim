...
export function helperCommand(
  ...
  if (
    !/^(ide.open|chat|agent.toggle|focus.other|width.less|width.more|quit|retry|help|status|resize|layout|focus|death|detach|confirm-quit|confirm-retry|popup)$/.test(
      action,
    ) ||
